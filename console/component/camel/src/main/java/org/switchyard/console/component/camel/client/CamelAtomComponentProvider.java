 ...
 * 
 * ComponentProvider for the Camel ATOM component.
 */
@ComponentExtension(displayName = "ATOM", componentName = "org.switchyard.component.camel.atom", activationTypes = "atom")
public class CamelAtomComponentProvider extends BaseComponentProvider {
