 ...
 * 
 * ComponentProvider for the Camel CXF component.
 */
@ComponentExtension(displayName = "CXF", componentName = "org.switchyard.component.camel.cxf", activationTypes = "cxf")
public class CamelCxfComponentProvider extends BaseComponentProvider {
