 ...
 * 
 * ComponentProvider for the Camel File component.
 */
@ComponentExtension(displayName = "File", componentName = "org.switchyard.component.camel.file", activationTypes = "file")
public class CamelFileComponentProvider extends BaseComponentProvider {
