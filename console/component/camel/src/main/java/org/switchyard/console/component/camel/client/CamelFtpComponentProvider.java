 ...
 * 
 * ComponentProvider for the Camel FTP component.
 */
@ComponentExtension(displayName = "FTP", componentName = "org.switchyard.component.camel.ftp", activationTypes = "ftp")
public class CamelFtpComponentProvider extends BaseComponentProvider {
