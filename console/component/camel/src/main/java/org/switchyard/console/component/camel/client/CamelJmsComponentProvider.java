 ...
 * 
 * ComponentProvider for the Camel JMS component.
 */
@ComponentExtension(displayName = "JMS", componentName = "org.switchyard.component.camel.jms", activationTypes = "jms")
public class CamelJmsComponentProvider extends BaseComponentProvider {
