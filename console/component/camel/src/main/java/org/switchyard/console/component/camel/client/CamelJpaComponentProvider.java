 ...
 * 
 * ComponentProvider for the Camel JPA component.
 */
@ComponentExtension(displayName = "JPA", componentName = "org.switchyard.component.camel.jpa", activationTypes = "jpa")
public class CamelJpaComponentProvider extends BaseComponentProvider {
