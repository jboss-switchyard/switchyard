 ...
 * 
 * ComponentProvider for the Camel Mail component.
 */
@ComponentExtension(displayName = "Mail", componentName = "org.switchyard.component.camel.mail", activationTypes = "mail")
public class CamelMailComponentProvider extends BaseComponentProvider {
