 ...
 * 
 * ComponentProvider for the Camel MQTT component.
 */
@ComponentExtension(displayName = "MQTT", componentName = "org.switchyard.component.camel.mqtt", activationTypes = "mqtt")
public class CamelMqttComponentProvider extends BaseComponentProvider {
