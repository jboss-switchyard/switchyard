 ...
 * 
 * ComponentProvider for the Camel Netty component.
 */
@ComponentExtension(displayName = "Netty", componentName = "org.switchyard.component.camel.netty", activationTypes = "netty")
public class CamelNettyComponentProvider extends BaseComponentProvider {
