 ...
 * 
 * ComponentProvider for the Camel Quartz component.
 */
@ComponentExtension(displayName = "Quartz", componentName = "org.switchyard.component.camel.quartz", activationTypes = "quartz")
public class CamelQuartzComponentProvider extends BaseComponentProvider {
