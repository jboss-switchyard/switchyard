 ...
 * 
 * ComponentProvider for the Camel RSS component.
 */
@ComponentExtension(displayName = "RSS", componentName = "org.switchyard.component.camel.rss", activationTypes = "rss")
public class CamelRssComponentProvider extends BaseComponentProvider {
