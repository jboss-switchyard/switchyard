 ...
 * 
 * ComponentProvider for the Camel SAP component.
 */
@ComponentExtension(displayName = "SAP", componentName = "org.switchyard.component.camel.sap", activationTypes = "sap")
public class CamelSapComponentProvider extends BaseComponentProvider {
