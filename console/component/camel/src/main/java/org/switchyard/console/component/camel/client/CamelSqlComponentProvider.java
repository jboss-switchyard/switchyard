 ...
 * 
 * ComponentProvider for the Camel SQL component.
 */
@ComponentExtension(displayName = "SQL", componentName = "org.switchyard.component.camel.sql", activationTypes = "sql")
public class CamelSqlComponentProvider extends BaseComponentProvider {
