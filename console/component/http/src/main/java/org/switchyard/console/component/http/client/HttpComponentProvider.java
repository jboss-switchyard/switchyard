 ...
 */
package org.switchyard.console.component.http.client;
 ...
 * 
 * ComponentProvider for the HTTP component.
 */
@ComponentExtension(displayName = "HTTP", componentName = "org.switchyard.component.http", activationTypes = "http")
public class HttpComponentProvider extends BaseComponentProvider {
