 ...
 */
package org.switchyard.console.component.resteasy.client;
...
/**
 * RESTEasyComponentProvider
 * 
 * ComponentProvider for the RESTEasy component.
 */
@ComponentExtension(displayName = "RESTEasy", componentName = "org.switchyard.component.resteasy", activationTypes = "resteasy")
public class RESTEasyComponentProvider extends BaseComponentProvider {
