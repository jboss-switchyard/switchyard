...
public final class NameTokens {
    ...
    /** The display text for the SwitchYard runtime/metrics navigator item. */
    public static final String RUNTIME_METRICS_TEXT = "SwitchYard - Metrics"; //$NON-NLS-1$
    /** The display text for the SwitchYard runtime/applications navigator item. */
    public static final String RUNTIME_APPLICATIONS_TEXT = "SwitchYard - Applications"; //$NON-NLS-1$
