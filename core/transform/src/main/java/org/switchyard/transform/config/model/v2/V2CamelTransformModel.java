...
/**
 * A version 2 CamelTransformModel.
 */
...
public class V2CamelTransformModel extends V1BaseTransformModel implements CamelTransformModel {
    ...
    /**
     * Constructs a new V2CamelTransformModel.
     * @param namespace namespace
     */
    public V2CamelTransformModel(String namespace) {
        super(new QName(namespace, TransformModel.TRANSFORM + '.' + CAMEL));
    }

    /**
     * Constructs a new V2CamelTransformModel with the specified Configuration and Descriptor.
     * @param config the Configuration
     * @param desc the Descriptor
     */
    public V2CamelTransformModel(Configuration config, Descriptor desc) {
        super(config, desc);
    }

    @Override
    public String getEndpointUri() {
        return getModelAttribute(ENDPOINT_URI);
    }

    @Override
    public CamelTransformModel setXsltFile(String uri) {
        setModelAttribute(ENDPOINT_URI, uri);
        return this;
    }
