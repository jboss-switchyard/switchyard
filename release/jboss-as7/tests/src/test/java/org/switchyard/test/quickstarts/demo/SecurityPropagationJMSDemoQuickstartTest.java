...
/**
 * The security-propagation-jms demo quickstart test.
 *
 */
@RunWith(Arquillian.class)
@ServerSetup(SecurityPropagationJMSDemoQuickstartTest.SSLSocketBindingSetupTask.class)
public class SecurityPropagationJMSDemoQuickstartTest {

    private static final String QUEUE_IN = "WorkStoreQueue";
    private static final String QUEUE_OUT = "WorkAckStoreQueue";

    private static String SRC_DIR = System.getProperty("jboss.home") + "/quickstarts/demos/security-propagation-jms";

    @Deployment(testable = false)
    public static JavaArchive createDeployment() throws Exception {
        System.out.println(ResourceDeployer.addQueue(QUEUE_IN));
        System.out.println(ResourceDeployer.addQueue(QUEUE_OUT));
        return ArquillianUtil.createJarDemoDeployment("switchyard-demo-security-propagation-jms");
    }

    @Test
    public void testUnsecure() throws Exception {
        String response = invokeWorkService("http", 8080, "security-propagation-jms", null, null);
