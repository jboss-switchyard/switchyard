...
import static org.switchyard.as7.extension.SwitchYardModelConstants.DEPLOYMENT;
...
public class SwitchYardExtension implements Extension {
    ...
    static final PathElement DEPLOYMENT_PATH = PathElement.pathElement(DEPLOYMENT);
    static final PathElement APPLICATION_PATH = PathElement.pathElement(APPLICATION);
