...
import org.jboss.ws.undertow_httpspi.UndertowHttpHandler;
...
/**
 * HTTP destination to be used with the undertow; this extends the
...
public class HttpServerDestination extends JAXWSHttpSpiDestination
{
   ...
   protected void activate()
   {
      ...
      engine.addHandler(addr, new SwitchYardHttpHandler(this, SecurityActions.getContextClassLoader()));
   }
   ...
   class SwitchYardHttpHandler extends UndertowHttpHandler
   {

      private ClassLoader classLoader;

      public SwitchYardHttpHandler(JAXWSHttpSpiDestination destination, ClassLoader classLoader)
      {
         super(new HttpHandlerImpl(destination));
